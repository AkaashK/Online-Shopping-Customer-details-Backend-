...
exports.getCustomers = async (req, res) => {
    try {        
        const rows = await customerDB.findAll({ offset : req.body.offset, limit : req.body.limit })
        res.send(rows)
    }
    catch (error) {
        res.sendStatus(403)
...
exports.getTotalIncome = async (req,res) => {
    try {
        const totalIncome = await customerDB.findAll({
...
exports.minPurchase = async (req,res) => {
    try {
        const minPurchase = await customerDB.findAll({
